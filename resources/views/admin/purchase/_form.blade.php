...
<div class="form-row">
    ...
    <div class="form-group col-md-4">
        ...
        <div class="input-group">
            ...
            <input type="number" value="0" class="form-control" name="tax" id="tax" aria-describedby="basic-addon3"
                placeholder="">
        </div>
    </div>
</div>
...
<div class="form-row">
    ...
    <div class="form-group col-md-4">
        <div class="form-group">
            ...
            <input type="number" class="form-control" name="quantity" id="quantity" aria-describedby="helpId" autocomplete="off">
        </div>
    </div>
    <div class="form-group col-md-2">
        <div class="form-group">
            <label for="price">Precio de compra</label>
            <input type="number" class="form-control" name="price" id="price" aria-describedby="helpId" autocomplete="off">
        </div>
    </div>
</div>
<div class="form-group">
