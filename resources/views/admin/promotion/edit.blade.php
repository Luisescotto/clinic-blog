                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" value="{{old('name', $promotion->name)}}" class="form-control @error('name') is-invalid @enderror" placeholder="" required>
                                @error('name')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="start_date" id="start_date" value="{{old('start_date', $promotion->start_date->format('d-m-Y H:i:s'))}}" class="date_time_picker form-control @error('start_date') is-invalid @enderror" placeholder="" required>
                                @error('start_date')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="ending_date" id="ending_date" value="{{old('ending_date', $promotion->ending_date->format('d-m-Y H:i:s'))}}" class="date_time_picker form-control @error('ending_date') is-invalid @enderror" placeholder="" required>
                                @error('ending_date')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-md-8">
                            <div class="form-group row">
                              ...
                              <div class="col-sm-4">
                                <div class="form-check">
                                  <label class="form-check-label">
                                    <input type="radio" class="form-check-input radio_type" name="promotion_type" id="promotion_type1" value="percent" @if($promotion->promotion_type == 'percent') checked @endif>
                                    Porcentaje
                                  </label>
                                </div>
                              </div>
                              <div class="col-sm-4">
                                <div class="form-check">
                                  <label class="form-check-label">
                                    <input type="radio" class="form-check-input radio_type" name="promotion_type" id="promotion_type2" value="fixed" @if($promotion->promotion_type == 'fixed') checked @endif>
                                    Monto fijo
                                  </label>
                                </div>
                              </div>
                        ...
                        <div class="col-md-4" id="div_discount_rate"  @if($promotion->promotion_type != 'percent') style="display: none" @endif>
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="discount_rate" id="discount_rate" maxlength="8" pattern="[0-9 .]*" value="{{old('discount_rate', $promotion->discount_rate)}}" class="form-control @error('discount_rate') is-invalid @enderror">
                                    @error('discount_rate')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="col-md-4" id="div_fixed_amount_discount"  @if($promotion->promotion_type != 'fixed') style="display: none" @endif>
                            <div class="form-group">                                
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="fixed_amount_discount" id="fixed_amount_discount" step="0.01" value="{{old('fixed_amount_discount', $promotion->fixed_amount_discount)}}" class="form-control @error('fixed_amount_discount') is-invalid @enderror">
                            ...
                            <div class="form-group">
                              ...
                              <select class="form-control selectpicker" name="products[]" id="products" data-live-search="true" data-size="4" multiple data-actions-box="true" data-selected-text-format="count > 1" title="Seleccione los productos a los que desea aplicar esta promoción" multiple>
                                  ...
                                  <option value="{{$product->id}}"
                                    ...
                                    {{collect(old('products', $promotion->products->pluck('id')))->contains($product->id) ? 'selected' : ''}}
