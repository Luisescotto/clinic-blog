                    ...
                    <tr>
                        <th>
                            <p id="proveedor">Nombre: {{$sale->user->name}}<br>
                                ...
                                {{-- Dirección: {{$sale->provider->address}}<br>
                                Teléfono: {{$sale->provider->phone}}<br> --}}
            ...
            <table id="facproducto">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>s/ {{number_format($saleDetail->quantity*$saleDetail->price - $saleDetail->quantity*$saleDetail->discount/100,2)}}</td>
                    </tr>
                    @endforeach
                </tbody>
                <tfoot>
