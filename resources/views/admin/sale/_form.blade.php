  ...
  <div class="form-row">
    <div class="form-group col-md-6">
        <div class="form-group">
            ...
            <input type="number" class="form-control" name="quantity" id="quantity" aria-describedby="helpId" value="1" min="1" onkeyDown="return false">
        </div>
    </div>
    <div class="form-group col-md-3">
        ...
        <div class="input-group">
            ...
            <input type="number" class="form-control" name="tax" id="tax" aria-describedby="basic-addon3" value="0" min="0" max="100" onKeyDown="return false">
        </div>
    </div>
    <div class="form-group col-md-3">
        ...
        <div class="input-group">
            ...
            <input type="number" class="form-control" name="discount" id="discount" aria-describedby="basic-addon2" value="0" min="0" max="100" onKeyDown="return false">
        </div>
    </div>
  </div>
