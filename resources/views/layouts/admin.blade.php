    ...
    <div class="container-scroller">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row default-layout-navbar">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo" href="{{route('home')}}"><img src="{{asset($web_company->logo)}}"
                        alt="logo" /></a>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
                          <a class="dropdown-item" href="{{route('mark_all_notifications')}}">
                            <p class="mb-0 font-weight-normal float-left">Tienes {{auth()->user()->unreadNotifications->count()}} nuevas notificaciones
                            </p>
                          ...
                          <a class="dropdown-item preview-item" href="{{route('mark_a_notification', [$notification->id, $notification->data['id']])}}">
                            ...
                            <div class="preview-item-content">
                              ...
                              <p class="font-weight-light small-text">
                                {{$notification->data['name']}} ha realizado un pedido por {{$notification->data['total']}} pesos.
                                <br>
            ...
            <div class="main-panel">
                ...
                <footer class="footer">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        ...
                        <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">{{$web_company->name}} </> <i class="far fa-heart text-danger"></i></span>
                    </div>
                </footer>
                <!-- partial -->
            </div>
